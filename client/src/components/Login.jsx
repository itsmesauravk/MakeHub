  ...
  return (
    <div className="relative flex h-screen">
      ...
      <div className="flex flex-col justify-center items-center w-full md:w-1/2 bg-gray-100 p-8">
        ...
        <p className="text-lg mt-2 mb-8 text-secondary">Please log in to your account</p>
      ...
      <button
        ...
        onClick={() => window.close()} // This will not work for most browsers; consider using a custom handler
      >
